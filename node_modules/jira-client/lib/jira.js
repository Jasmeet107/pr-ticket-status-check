...
function () {
  ...
  (0, _createClass2["default"])(JiraApi, [{
    ...
    key: "doRequest",
    value: function () {
      var _doRequest = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee(requestOptions) {
        var options, response;
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                options = _objectSpread({}, this.baseOptions, {}, requestOptions);
                _context.next = 3;
    ...
    value: function () {
      var _getUnresolvedIssueCount = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    key: "findRapidView",
    value: function () {
      var _findRapidView = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee3(projectName) {
    ...
    value: function () {
      var _getLastSprintForRapidView = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee4(rapidViewId) {
        var response;
